            ...
            <div class="col-4">
                <div class="list-group">
                    <router-link :to="{ name: 'dashboard' }"
                        class="list-group-item list-group-item-action">Dashboard</router-link>
                    <router-link :to="{ name: 'user-profile' }" class="list-group-item list-group-item-action">User
                        Profile</router-link>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Your name"
                                            ...
                                            :class="{ 'is-invalid': userProfile.errors.has('name') }">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Your email"
                                            ...
                                            :class="{ 'is-invalid': userProfile.errors.has('email') }">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" placeholder="Your password"
                                            ...
                                            :class="{ 'is-invalid': userProfile.errors.has('password') }">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" placeholder="Confirm password"
                                            ...
                                            :class="{ 'is-invalid': userProfile.errors.has('password_confirmation') }">
